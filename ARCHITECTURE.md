...
| Автоматический Bitrix-цикл в будни 08:00–18:00 МСК и слот 15:50 | `api/daytime_cycle.py` | `api/app.py`, `api/jobs.py`, `api/deal_control.py`, `api/manager_trajectory.py`, `storage/rop_db.py`, `frontend/src/DealControl.tsx` |
