...
| Browser UI и клиентские контракты | `frontend/src/App.tsx`, `frontend/src/DealControl.tsx`, `frontend/src/DailyControl.tsx`, `frontend/src/DealReviewCard.tsx`, `frontend/src/api.ts`, `frontend/src/dealPush.ts` |
