...
- Малое изменение делай сам. Lead самостоятельно решает, когда делегирование выгоднее самостоятельной работы; отдельная просьба пользователя о worker не требуется. Делегируй только когда экономия превышает передачу контекста и интеграцию; архитектура и приёмка остаются у lead.
