...
CLOSED_REASON_INSTRUCTIONS: dict[str, str] = {
    ...
    "price_lost": "Проверить, была ли защищена ценность, комплектация, сроки, сервис, лизинг или альтернатива по составу.",
    "postponed": "Не считать окончательной потерей без контрольной даты. Нужна реактивация или прогрев.",
    "wrong_qualification": "Искать спорное закрытие: если есть потребность, деньги, срок или путь к ЛПР, подсветить РОПу возврат в воронку.",
