...
INCREMENTAL_LLM_ANALYSIS = "INCREMENTAL_LLM_ANALYSIS"
ERROR = "ERROR"
...
def soft_diff_triggers(diff: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    mapping = {
        ...
        "manager_worklog_added": "manager_worklog_added_without_llm",
        "manager_worklog_changed": "manager_worklog_changed_without_llm",
...
def trigger_label(trigger: dict[str, Any]) -> str:
    ...
    labels = {
        ...
        "manager_worklog_added_without_llm": "Найден рабочий журнал менеджера",
        "manager_worklog_changed_without_llm": "Обновлён рабочий журнал менеджера",
