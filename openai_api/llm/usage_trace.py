...
def build_daily_usage_line(event: dict[str, Any]) -> tuple[str, str]:
    ...
    fields = [
        ...
        f"provider={_one_line(event.get('provider'))}",
        ...
        f"provider_fallback={_one_line(event.get('provider_fallback'))}",
...
def build_usage_trace_event(
    ...
    *,
    ...
    return {
        ...
        "provider_fallback": bool(metadata.get("provider_fallback")),
        "provider_fallback_reason": metadata.get("provider_fallback_reason"),
