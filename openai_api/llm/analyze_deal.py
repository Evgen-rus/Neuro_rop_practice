...
# Одна формулировка next_action для FULL и incremental/V2, чтобы автообновление
# не переоценивало тот же бизнес-факт иначе, чем полный анализ.
COMMUNICATION_QUALITY_AUDIT_NEXT_ACTION_RULE = (
    "next_action=1, если в содержательной клиентской коммуникации зафиксирован "
    "достаточно конкретный временной ориентир следующего действия или ожидаемого результата. "
    "Точное время НЕ обязательно. "
    "Критерий проверяет только наличие нормального следующего шага по времени; "
    "не проверяй, является ли действие шагом к договору. "
    "Временной ориентир может относиться не только к действию менеджера, но и к клиенту, "
    "производству, складу или ожидаемому результату. "
    "Считать 1: «завтра»; «во вторник»; «на следующей неделе во вторник»; "
    "«через пару дней»; «в течение двух рабочих дней»; «к концу недели»; "
    "«в первой половине следующей недели»; «завтра днём»; "
    "«завтра постараюсь уточнить и отзвонюсь»; «завтра информация должна быть»; "
    "«Завтра наберу»; «Во вторник наберу»; "
    "«На следующей неделе во вторник созвонимся»; «Через пару дней дам ответ»; "
    "«В течение двух рабочих дней подготовим»; «К концу недели вернусь с ответом»; "
    ...
    "Считать 0: «на следующей неделе» без дня или более узкого периода; "
    "«в ближайшее время»; «на днях»; «попозже»; «скоро»; "
    "«будет время — посмотрю»; «чуть-чуть подождите»; "
    "действие вообще без временного ориентира; "
    "«На следующей неделе созвонимся»; «В ближайшее время»; «На днях»; "
    "«Попозже»; «Скоро»; «Будет время, посмотрю»; «Чуть-чуть подождите»; "
    "«Я сейчас передам информацию на склад» без срока результата."
)
