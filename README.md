...
После старта API в будни с 08:00 до 18:00 МСК каждые 30 минут (и в 15:50 МСК) синхронизирует Bitrix, копит CRM-факты и запускает существующий FULL/MINI/skip. Ночью и в выходные не запускается. Отключить: `DAYTIME_CYCLE_ENABLED=false`.
